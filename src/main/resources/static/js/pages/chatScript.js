...
var commandMap = [
    ...
    [ // 메세지 하나 처리하는 자료구조 
        ...
        [   // 1 = 응답 할 내용
            '<li class="other">',
            '<span class="btn-text" style="color:black"><b> "라이프 / 커뮤니티 / 정보 / <br>마이 페이지"</b> <br> 중 원하시는 키워드 입력해주세요!',
            '</li>',
        ]
    ],
    ...
    [ // 메세지 하나 처리하는 자료구조 
        ...
        [   // 1 = 응답 할 내용
            ...
            '<li class="other">',
            '<span class="btn-text" style="color:black">스모어는 1인가구를 위해 만들어진 사이트 입니다. 1인가구들을 위한 유용한 정보들과 다른 1인가구들과 소통하며 더 멋진 삶을 만들어보실 수 있습니다 !<br><br> ⌛️ 처음으로 돌아가길 원하시면<b>\'"다시 시작"\'</b>을 입력해 주세요.  ',
            '</li>',
        ]
    ],
    ...
    [   // 1 = 응답 할 내용
        '<li class="other">',
        '<span class="btn-text" style="color:black"><b>중고재능거래 / 레시피 / <br>야외활동</b> 중 원하시는 메뉴를 입력해주세요!',
        '</li>',
    ]
],
...
[   // 1 = 응답 할 내용
    '<li class="other">',
    '<span class="btn-text" style="color:black"><b>"공공임대주택 / 정부지원사업 / 뉴스"</b> 중 원하시는 메뉴를 입력해주세요!',
    '</li>',
]
],
